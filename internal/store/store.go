...
type SessionStore interface {
	...
	// PutFBPrepJob creates or replaces an FB prep job record.
	PutFBPrepJob(ctx context.Context, sessionID string, job *FBPrepJob) error

	// GetFBPrepJob retrieves an FB prep job. Returns nil, nil if not found.
	GetFBPrepJob(ctx context.Context, sessionID, jobID string) (*FBPrepJob, error)
